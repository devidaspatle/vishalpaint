...
//$payment_month = date('m', strtotime($tra/nsdate));
...
$sqlgs = "SELECT * FROM loan_installment order by id desc";
$resultQgls = mysqli_query($con, $sqlgs); 
$rowloan = mysqli_fetch_array($resultQgls);
$customer_id = $rowloan['id'];
...
else
{
	...
	echo '<script type="text/javascript">window.location.assign("loan_installment_code.php");</script>';	
}
