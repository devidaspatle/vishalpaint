...
$resultExecutive = mysqli_query($con, "SELECT * FROM executive_member where id = $exet_id");
...
<?php include "left.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<h2>Edit Executive Registration</h2>
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>Edit Executive Registration&nbsp;&nbsp;</span></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<input type="hidden" name="customerid" id="customerid"  value="<?php echo $rowExecutive['customer_id'];?>" />
							<input type="hidden" name="executiveid" id="executiveid"  value="<?php echo $rowExecutive['id'];?>" />
								<section class="panel">

									<header class="panel-heading">

										<h2 class="panel-title">Edit Executive Registration</h2>
									...
									<div class="panel-body">
										...
										<label class="col-sm-4 control-label">First Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="firstName" id="firstName" maxlength="100" class="form-control" required readonly="readonly" value="<?php echo $rowExecutive['firstName'];?>" />
										...
										<label class="col-sm-4 control-label">Middle Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="middleName" id="middleName" readonly="readonly" maxlength="100" class="form-control" required value="<?php echo $rowExecutive['middleName'];?>" />
										...
										<label class="col-sm-4 control-label">Last Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="lastName" id="lastName" maxlength="100" class="form-control" required readonly="readonly" value="<?php echo $rowExecutive['lastName'];?>" />
											...
											<div class="col-sm-8">
												...
												<input type="text" name="father_name" id="father_name" maxlength="100" class="form-control" readonly="readonly" required value="<?php echo $rowExecutive['father_name'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="email" required name="emailid" id="emailid" readonly="readonly" onChange="check_mail_id()" maxlength="100" class="form-control" value="<?php echo $rowExecutive['emailid'];?>"  /><!--required-->
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="text" name="mobile_number" id="mobile_number" readonly="readonly" maxlength="12" class="form-control"  required value="<?php echo $rowExecutive['mobile_number'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<option value="">Select Perent ID</option>
                                                 <?php 
												while($rowExecutives = mysqli_fetch_array($resultExecutives))
												{
												$name_of_applicant =	$rowExecutives['firstName'].' '.$rowExecutives['middleName'].' '.$rowExecutives['lastName']
												?>
									<option value="<?php echo $rowExecutives['application_no'];?>" <?php if($rowExecutives['application_no'] == $rowExecutive['parent_id']) { echo "selected='selected'";}?>><?php echo ucwords($name_of_applicant);?></option>	
												<?php }?>
											</select>
										...
										<input type="date" name="date_of_join" id="date_of_join"  maxlength="30" required  class="form-control"  value="<?php echo $rowExecutive['date_of_join'];?>">
