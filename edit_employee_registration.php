								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
											<select id="idprooftype" name="idprooftype" class="form-control" required >
												...
												{
												?>
												<option value="<?php echo $rowIdproofType['id'];?>" <?php if($rowIdproofType['id'] == $rowQgl['idprooftype']) { echo "selected='selected'";}?>> <?php echo $rowIdproofType['proof_type'];?></option>	
												<?php }?>
											</select>
