...
{
$resultExecutive = mysqli_query($con, "SELECT * FROM executive_member where  	application_no  = '$applicationno'");
...
$resultCommission = mysqli_query($con, "SELECT * FROM executive_tds  where  application_no  = '$applicationno' and  promotions = '1'");
...
<?php include "left.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group col-sm-12">
										...
										<div class="col-sm-4">
										        ...
										        <select name="applicationno" id="applicationno"  class="form-control" required>
						...
						<div>&nbsp;</div>
					<div class="col-md-12">
							<?php if(!empty($rowExecutiver)) { ?>
							<form id="form"  method="POST" action="executive_promotions_code.php" class="form-horizontal" onSubmit="disable();">
							<input type="hidden" name="application_no" id="application_no"  value="<?php echo $rowExecutiver['application_no'];?>" />
                            <input type="hidden" name="executive_id" id="executive_id"  value="<?php echo $rowExecutiver['id'];?>" />
<input type="hidden" name="tds_price" id="tds_price"  value="<?php echo $rowsCommi['tds_price'];?>" />
								<section class="panel">
									...
									<div class="panel-body">
										...
										<label class="col-sm-4 control-label">Last Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="father_name" id="father_name" maxlength="100" class="form-control" readonly="readonly" required value="<?php echo $rowExecutiver['father_name'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<select id="commission_parcent" name="commission_parcent" class="form-control" required>
												...
												?>
									<option value="<?php echo $rowTds['commission_parcent'];?>"<?php if( $rowTds['commission_parcent'] == $rowsCommi['commission_parcent']) { echo "selected='selected'";}?>>
										<?php echo $rowTds['commission_parcent'];?>%</option>	
												<?php }?>
											</select>
