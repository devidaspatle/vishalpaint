...
{
$resultCustomer = mysqli_query($con, "SELECT * FROM executive_member where application_no =  '".$applicationno."'");
}
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span> Advance Payment&nbsp;&nbsp;</span></li>
					...
					<div class="row">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
									...
									<div class="form-group col-sm-12">
										...
										<div class="col-sm-4">
                                        <select name="applicationno" id="applicationno"  class="form-control">
						...
						<div class="col-md-12">
							...
							<input type="hidden" name="customerid" id="customerid"  value="<?php echo $applicationno;?>" />
								<section class="panel">

									<header class="panel-heading">

										<h2 class="panel-title"> Advance Payment</h2>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="date" name="advance_date" id="advance_date" value="" maxlength="30" required  class="form-control"  value="<?php echo $rowCustomer['advance_date'];?>">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
                                                 	...
                                                 	<textarea name="description" class="form-control" cols="80"></textarea>
												</div>
