...
$resultCustomer = mysqli_query($con, "SELECT * FROM advance_payment where id = $typeid");
...
<?php include "left.php"; ?>
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<h2>Executive Advance Payment</h2>
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>Executive Advance Payment&nbsp;&nbsp;</span></li>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<form id="form"  method="POST" action="advance_payment_code.php" class="form-horizontal" onSubmit="disable();">
							<input type="hidden" name="customerid" id="customerid"  value="<?php echo $rowCustomer['customer_id'];?>" />
							<input type="hidden" name="adcustomerid" id="adcustomerid"  value="<?php echo $rowCustomer['id'];?>" />
								<section class="panel">

									<header class="panel-heading">

										<h2 class="panel-title">Executive Advance Payment</h2>
									...
									<div class="panel-body">
										...
										<label class="col-sm-4 control-label">First Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="firstName" id="firstName" maxlength="100" class="form-control" required readonly="readonly" value="<?php echo $rowCustomer['firstName'];?>" />
										...
										<label class="col-sm-4 control-label">Middle Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="middleName" id="middleName" readonly="readonly" maxlength="100" class="form-control" required value="<?php echo $rowCustomer['middleName'];?>" />
										...
										<label class="col-sm-4 control-label">Last Name <span class="required">*</span></label>
											...
											<div class="col-sm-8">
												...
												<input type="text" name="lastName" id="lastName" maxlength="100" class="form-control" required readonly="readonly" value="<?php echo $rowCustomer['lastName'];?>" />
											...
											<div class="col-sm-8">
												...
												<input type="text" name="father_name" id="father_name" maxlength="100" class="form-control" readonly="readonly" required value="<?php echo $rowCustomer['father_name'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="email" required name="emailid" id="emailid" readonly="readonly" onChange="check_mail_id()" maxlength="100" class="form-control" value="<?php echo $rowCustomer['emailid'];?>"  /><!--required-->
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="text" name="mobile_number" id="mobile_number" readonly="readonly" maxlength="12" class="form-control"  required value="<?php echo $rowCustomer['mobile_number'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Advance Payment <span class="required">*</span></label>

											<div class="col-sm-8">

												<input type="text" name="advance_payment" id="advance_payment"  maxlength="12" class="form-control"  required value="<?php echo $rowCustomer['advance_payment'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Advance Date <span class="required">*</span></label>
										...
										<input type="date" name="advance_date" id="advance_date" maxlength="30" required  class="form-control"  value="<?php echo $rowCustomer['advance_date'];?>">
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
                                                 	...
                                                 	<textarea name="description" class="form-control" cols="80"><?php echo $rowCustomer['description'];?></textarea>
												</div>
...
<input type="hidden" name="Update" id="Update"   value="Update">
												...
												<button type="button" onClick="window.location.href='executive_advances.php'" name="" class="btn btn-default">Back</button>
