...
$resultPlantype = mysqli_query($con, "SELECT * FROM plan_master where id = '$plan_type'");
?>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>View Customer Registration&nbsp;&nbsp;</span></li>
...
<div style="text-align:center; font-size:14px;color:#000066"><h5><b>Email:bhoyarnathnidhi@gmail.com&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Phone. No. 7744965631, 776870623</b></h5></div>
										...
										<div style="text-align:center"><h2 class="panel-title"><b>View Customer Details</b></h2></div></td>
									</tr>
                                    <tr>
									   <td>First Name </td>
										<td><?php echo $rowCustomers['firstName'];?></td>
										<td>Middle Name</td>
										<td><?php echo $rowCustomers['middleName'];?></td>
									</tr>
                                    <tr>
									   <td>Last Name </td>
										<td><?php echo $rowCustomers['lastName'];?></td>
										<td>Father/Husband</td>
										<td><?php echo $rowCustomers['father_name'];?></td>
									</tr>
                                    <tr>
									   <td>Gender</td>
                                     ...
                                     <tr>
									   <td>Address</td>
										<td> <?php echo $rowCustomers['present_address'];?></td>
										<td>City</td>
										<td><?php echo $rowCustomers['present_city'];?></td>
									</tr>
                                     <tr>
									   <td>State</td>
										<td> <?php 
												 ...
												 ?></td>
										<td>Pincode</td>
										<td><?php echo $rowCustomers['present_pincode'];?></td>
									</tr>
                                       <tr>
									   <td colspan="4"><h5><b>Permanent  Address</b></h5></td>	
									</tr>
                                    <tr>
									   <td>Address</td>
										<td> <?php echo $rowCustomers['permanent_address'];?></td>
										<td>City</td>
										<td><?php echo $rowCustomers['permanent_city'];?></td>
									</tr>
                                     <tr>
									   <td>State</td>
										<td><?php 
									 ...
									 ?></td>
										<td>Pincode</td>
										<td><?php echo $rowCustomers['permanent_pincode'];?></td>
									</tr>
                                     <tr>
									   <td>Date of Join </td>
										<td><?php 
										...
										<td>Age</td>
										<td><?php echo $rowCustomers['age'];?></td>
									</tr>
                                     <tr>
									   <td>Date of Birth </td>
										<td>
										...
										<td><?php echo $rowCustomers['emailid'];?></td>
                                                                         ...
                                                                         <tr>
									   <td colspan="4"><h5><b>Payment Details </b></h5></td>	
									</tr>
                                     

                                                                        <tr>
									   <td>PAN No.</td>
										<td> <?php echo $rowCustomers['pan_number'];?></td>
										<td>Nationality</td>
									   ...
									   <td>ID proof Type</td>
										...
										<td><?php echo $rowCustomers['id_number'];?></td>
									</tr>
									<tr>
									   <td>Plan Type</td>
										<td><?php 
												$rowPlanType = mysqli_fetch_array($resultPlantype);
												 echo $rowPlanType['plan_name'];?>Year
									</td>
										<td>Price</td>
                                    ...
                                    <tr>
									   <td>payment Mode</td>
										<td> <?php 
												...
												?></td>
										<td>Mode Number</td>
										<td>	<?php echo $rowCustomers['payment_number'];?>
</td>
									</tr>
