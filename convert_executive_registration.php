					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span> Executive Business&nbsp;&nbsp;</span></li>
							...
							<input type="hidden" name="member_type"   value="Y" />
								<section class="panel">
									...
									<header class="panel-heading">
										...
										<h2 class="panel-title"> Executive Business</h2>
								...
								<div class="form-group col-sm-6">
										...
										<label class="col-sm-4 control-label">Customer Number <span class="required">*</span></label>

											<div class="col-sm-8">

												<input type="text" name="customerId"  maxlength="100" class="form-control" required readonly="readonly" value="<?php echo $rowCustomer['application_no'];?>" />
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
                                                ...
                                                <option value="1001">Bhoyarnath Mutual Nidhi Limited</option>
                                                 <?php 
												while($rowExecutive = mysqli_fetch_array($resultExecutive))
												{
												$num = mysqli_query($con, "SELECT * FROM executive_member  where application_no='".$rowExecutive['application_no']."'");
...
<!--div class="form-group col-sm-6">
                                            ...
                                            <select name="member_type" id="member_type">
                                               <option value="0">Select Member Type</0option>	
                                                <option value="0">Customer</0option>	
                                              <option value="1">Executive</0option>
                                            </select>
										...
										<div class="form-group col-sm-6">
											...
											<div class="col-sm-8">
												...
												<div class="input-group">
													...
													<input type="date" name="date_of_join" id="date_of_join" maxlength="30" required  class="form-control"  value="">
