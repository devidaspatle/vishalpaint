...
$applicationno = $_POST['customer_id'];
...
<?php include "left.php"; ?>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span>Customer Installment &nbsp;&nbsp;</span></li>
								...
								<div class="col-md-12">
									...
									<div class="form-group col-sm-12">
										...
										<div class="col-sm-4">
											...
											<input type="text" placeholder="Customer ID" name="customer_id" id="customer_id" onKeyPress="return isNumber(event,'ration')" class="form-control digits" maxlength="15" required value="" />
							...
							<input type="hidden" name="customer_id" id="customer_id"  value="<?php echo $_POST['customer_id'];?>" />
								<section class="panel">
									...
									<header class="panel-heading">
										...
										<h2 class="panel-title">Customer Installment</h2>
 ...
 <div class="form-group col-sm-6">
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Mode Number <span class="required">*</span></label>

											<div class="col-sm-8">

												
											<input type="text" name="mode_number" id="mode_number"  class="form-control"  required value="" />
												<span class="red" id="err_emptype"></span>
										...
										<div class="form-group col-sm-6">
											...
											<label class="col-sm-4 control-label">Payment Installment <span class="required">*</span></label>

											<div class="col-sm-8">

												
											<input type="text" name="payment_price" id="payment_price"  class="form-control"  required value="" />
												<span class="red" id="err_emptype"></span>
