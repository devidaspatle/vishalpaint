...
$sqlg = "SELECT * FROM customer_installment where application_no = '$customer_id' and payment_month = '".$payment_month."' order by id desc";
$resultQgl = mysqli_query($con, $sqlg); 
$rowPayment = mysqli_fetch_array($resultQgl);

$resultCustomers = mysqli_query($con, "SELECT * FROM customer_registration where application_no = '$customer_id'");
...
&nbsp;&nbsp;
                                    ...
                                    <tr>
									   <td>Customer ID:</td>
										<td><?php echo $rowCustomers['application_no'];?></td>
										<td>Full Name:</td>
										<td><?php echo $name =  ucfirst($rowCustomers['firstName']).' '.ucfirst($rowCustomers['middleName']).' '. ucfirst($rowCustomers['lastName']);?></td>
									</tr>
                                    <tr>
									   <td>Amount(Rs):</td>
										<td><?php echo $rowPayment['payment_price'];?>/-	</td>
										<td>AMT.in words: </td>
										<td><?php 
												$payment_price = $rowPayment['payment_price'];
                                    ...
                                    <tr>
									   <td>Payment Type: </td>
										...
										<td><?php 
												...
												?>:</td>
										<td><?php echo $rowPayment['payment_number'];?>
</td>
									</tr>
